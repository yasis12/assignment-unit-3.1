...
let favoriteFoods = ['chicken', 'steak', 'noodles' ]
...
console.log('The last animal in the array: ', animalArray[3]);

// 3.c. (STRETCH) TODO: Log the last animal by using the array length, 
//      instead of the exact index number of the last item
console.log('The last animal in the array using array length: ', animalArray[animalArray.length - 1]);
...
console.log('The food is now', favoriteFoods);
...
favoriteFoods.unshift('Ice Cream Sandwich');
...
favoriteFoods.reverse(); // this indeed reverses the array but not alphabitized 
